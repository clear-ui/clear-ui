...
export default class CustomizationDocs extends React.Component {
	render() {
		return <DocPage>
			...
			{`
			In order to create reusable components with modified styles based on other components,
			you can use function \`composeStyles\`.
			It allows to compose original styles definition with additional styles.
			`}
