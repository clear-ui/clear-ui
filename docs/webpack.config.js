...
config.resolve.alias['clear-ui-base/lib'] = path.join(__dirname, 'node_modules/clear-ui-base/src')
config.resolve.alias['clear-ui-material/lib'] =
	path.join(__dirname, 'node_modules/clear-ui-material/src')
config.resolve.alias['clear-ui-simple/lib'] =
	path.join(__dirname, 'node_modules/clear-ui-simple/src')
...
config.module.loaders[0].include = [
	...
	path.resolve(__dirname, '..', 'clear-ui-simple', 'src'),
]
